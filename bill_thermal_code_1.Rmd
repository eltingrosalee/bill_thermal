...
library(tidyr)
```
To use this Thermal Package, you will also have to download ExifTools here: https://exiftool.org/install.html

**Convert the FLIR jpeg to a regular one**
```{r}
convertflirJPG("IR_1913.jpg", exiftoolpath = "installed" ,  headerindex=1)
```


```{r load library and test image}
library(Thermimage)
